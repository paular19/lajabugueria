...
export default function ContactForm() {
  ...
  return (
    ...
    <input type="text" name="name" id="full-name" placeholder="Nombre y Apellido" required="" className="input-contacto-r"/>
      </div>
    ...
    <div className="input-field">
    <label for="full-name" className="nombre"></label>
    <textarea name="nombre" id="nombre" placeholder="Mensaje" required="" className="input-contacto-msj-msj"></textarea>
    </div>
    </div>
